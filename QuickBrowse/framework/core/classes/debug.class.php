	...
	function call_shutdown($isCalled = false){
		...
		if( isset($last) && $last['type'] == 64 | 16 | 4 | 1 | 256 | 2048 ){
			...
			if(!$this->QB->IS_LIVE){
				...
				. "<html>"
					. "<head>"
						. "<link rel=\"stylesheet\" href=\"http://quickbrow.se/QuickBrowse/.src/assets/css/lib/bootstrap/bootstrap.min.css\">"
						. "<link rel=\"stylesheet\" href=\"http://quickbrow.se/QuickBrowse/.src/assets/css/utility.css\">"
						. "<link rel=\"stylesheet\" href=\"http://quickbrow.se/QuickBrowse/.src/assets/css/responsive.css\">"
					. "</head>"
					. "<body>"
						. "<div class=\"container-fluid bg-gradient-purple\" style=\"margin: 0; min-height: 100vh;\">"
							...
							. "</div>"
						. "</div>"
						. "<script src=\"http://quickbrow.se/QuickBrowse/.src/assets/js/lib/jquery/jquery-slim.min.js\"></script>"
						. "<script src=\"http://quickbrow.se/QuickBrowse/.src/assets/js/lib/bootstrap/bootstrap.js\"></script>"
					. "</body>"
				. "</html>"
				);
